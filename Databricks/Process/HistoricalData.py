...
jdbc_url = "jdbc:sqlserver://sqlsv-base-prod.database.windows.net.database.windows.net:1433;database=sqldb-base-prod"
mode = "overwrite"
properties = {
    "user": "adminChallenge",
...
# DBTITLE 1,Write for frist time in gold
...
# DBTITLE 1,Mege Tables Silver to Gold
